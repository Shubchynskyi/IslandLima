...
public class EntitySettings {
    ...
    public static final int boaMaxPerCell = 6; //30 //6
    ...
    public static final int foxMaxPerCell = 6; //30 //6
    ...
    public static final int bearMaxPerCell = 2; //5 //2
    ...
    public static final int eagleMaxPerCell = 4; //20 //4
    ...
    public static final int horseMaxPerCell = 4; //20 //4
    ...
    public static final int rabbitMaxPerCell = 30; //150 //30
    ...
    public static final int mouseMaxPerCell = 100; //500 //100
    ...
    public static final int goatMaxPerCell = 28; //140 //28
    ...
    public static final int sheepMaxPerCell = 28; //140 //28
    ...
    public static final int boarMaxPerCell = 10; //50 //10
    ...
    public static final int buffaloMaxPerCell = 5; //10 //2
    ...
    public static final int duckMaxPerCell = 40; //200 //40
    ...
    public static final int caterpillarMaxPerCell = 200; //1000 //200
    ...
    public static final int deerMaxPerCell = 4; //20 //4
...
//    }
    ...
    public static final double grassWeight = 1; //1 //
    public static final int grassMaxPerCell = 40; //200 //40
